...
This issue tracker is only for technical issues related to CDI Core.
General CDI questions and/or support requests and are best directed to the [CDI Discord](https://discord.gg/sbgdcdv).
...
### What version of CDI Core are you using?
