Contributing to CDI Core
============================

The CDI Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CDI Core project, and is not to be
confused with overall CDI Network Protocol consensus changes.

Whether a pull request is merged into CDI Core rests with the project merge
...
Patches that change CDI consensus rules are considerably more involved than
...
Where a patch set proposes to change the CDI consensus, it must have been
...
The project leader is the release manager for each CDI Core release.
