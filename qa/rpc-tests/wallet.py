...
#   c) node1 mines 32 blocks, so now node 0 has 60001cdi, node 1 has 4250cdi, node2 has none.
#   d) node0 sends 601 cdi to node2, in two transactions (301 cdi, then 300 cdi).
