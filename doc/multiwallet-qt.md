...
In order to support loading of multiple wallets in cdi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cdi.cpp.
...
Changes to cdi.cpp
----------------------
cdi.cpp is the entry point into cdi-qt, and as such, will require some minor modifications to provide hooks for
