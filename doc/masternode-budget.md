...
CDI now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<cdi_address\> \<monthly_payment_cdi\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ CDI, _12_ times over the course of a year totaling _24000_ CDI.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<cdi_address\> \<monthly_payment_cdi\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` CDI.
