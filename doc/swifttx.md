...
* WebSocket: [https://github.com/cdiproject/insight-api-cdi#web-socket-api](https://github.com/cdiproject/insight-api-cdi#web-socket-api) 
* API: [https://github.com/cdiproject/insight-api-cdi#swifttx-transactions](https://github.com/cdiproject/insight-api-cdi#swifttx-transactions) 
...
By default, the CDI Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CDI Core daemon:
