...
The key and certificate is in a separate, passcdiase-protected keychain file that is
...
The key and certificate were exported into a separate, passcdiase-protected PKCS#12 file, and
...
install a keylogger to get the passcdiase that protects them.
