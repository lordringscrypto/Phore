                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CDI Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CDI address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cdi: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCDI"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CDI Core"), this);
    aboutAction->setStatusTip(tr("Show information about CDI Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CDI"));
    ...
    changePasscdiaseAction = new QAction(QIcon(":/icons/key"), tr("&Change Passcdiase..."), this);
    changePasscdiaseAction->setStatusTip(tr("Change the passcdiase used for wallet encryption"));
    unlockWalletAction = new QAction(tr("&Unlock Wallet..."), this);
    unlockWalletAction->setToolTip(tr("Unlock wallet"));
    lockWalletAction = new QAction(tr("&Lock Wallet"), this);
    signMessageAction = new QAction(QIcon(":/icons/edit"), tr("Sign &message..."), this);
    signMessageAction->setStatusTip(tr("Sign messages with your CDI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CDI addresses"));
    bip38ToolAction = new QAction(QIcon(":/icons/key"), tr("&BIP38 tool"), this);
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passcdiase"));
    ...
    openAction->setStatusTip(tr("Open a CDI: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CDI Core help message to get a list with possible CDI command-line options"));
    ...
    if (walletFrame) {
        ...
        connect(changePasscdiaseAction, SIGNAL(triggered()), walletFrame, SLOT(changePasscdiase()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    if (walletFrame) {
        ...
        settings->addAction(changePasscdiaseAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    changePasscdiaseAction->setEnabled(enabled);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CDI Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CDI network", "", count));
}
...
{
    QString strTitle = tr("CDI Core"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        changePasscdiaseAction->setEnabled(false);
    ...
    case WalletModel::Unlocked:
        ...
        changePasscdiaseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);
