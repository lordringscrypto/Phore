...
extern std::string HelpRequiringPasscdiase();
...
extern UniValue walletpasscdiase(const UniValue& params, bool fHelp);
extern UniValue walletpasscdiasechange(const UniValue& params, bool fHelp);
